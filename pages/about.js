      ...
      <div className="layout-wrapper">
        ...
        <div className="about-container">
          <div className="about-section">
            <h1>About Me</h1>
            <p>
              I’m Francis Mwangi, a full stack software developer and technical
              writer.
            </p>
            <p>
              I started this website as a place to document everything I learned
              while going through a career change. I learn in public and write
          ...
          <div className="about-section">
            ...
            <ul>
              ...
              <li>
                ...
                – Convert milliseconds or seconds to days, hours, minutes, and
                seconds in node.js.
              </li>
              <li>
                <a href="https://github.com/showdownjs/showdown">Showdown</a> –
                A bidirectional Markdown to HTML to Markdown converter written
                in Javascript.
              </li>
              <li>
          ...
          <div className="about-section">
            ...
            <ul>
              <li>
                <strong>Computer</strong>: Custom Linux Desktop
              </li>
              <li>
              ...
              <li>
                <strong>Editor</strong>: <a href="#">Vscode</a>
              </li>
              <li>
